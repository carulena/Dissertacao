...
\sigla{sdm}{SDM}{Modelagem de Distribuição de Espécies, do inglês \textit{Species Distribution Modeling}}

\sigla{enm}{ENM}{Modelagem de Nicho Ecológico, do inglês \textit{Ecological Niche Modeling}}

\sigla{ndvi}{NDVI}{Índice de Vegetação por Diferença Normalizada, do inglês \textit{Normalized Difference Vegetation Index}}

\sigla{ndwi}{NDWI}{Índice de Água Diferencial Normalizado, do inglês \textit{Normalized Difference Water Index}}

\sigla{pdi}{PDI}{Processamento Digital de Imagens}
\sigla{garp}{GARP}{Algoritmo Genético para Produção de Conjunto de Regras, do inglês \textit{Genetic Algorithm for Rule Set Production}}

\sigla{maxent}{MaxEnt}{Entropia Máxima, do inglês \textit{Maximum Entropy}}

\sigla{svm}{SVM}{Máquina de Vetores de Suporte, do inglês \textit{Support Vector Machines}}

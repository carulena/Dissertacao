...
%%
\include{./capitulos/cap-trabalhos-correlatos}

%% Capítulo
\include{./capitulos/cap-desenvolvimento}%% Comente para remover este item
...
%\begin{apendicesenv}
   ...
   \include{./PosTexto/apendicec}%% Apêndice - Comente para remover este item
%\end{apendicesenv}

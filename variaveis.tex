...
\author{ANE CAROLINA SIMÕES}  % Seu nome
\authorbib{Simões, Ane Carolina} % Seu nome para referência bibliográfica (Sobrenome, Nome)
\title{RecomendAbelha: Sistema de Recomendação de espécies de abelha sem ferrão para a prática de meliponicultura
} % Título do trabalho
